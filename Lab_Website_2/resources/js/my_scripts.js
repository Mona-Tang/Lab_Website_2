...
function loadStatsPage()  {
	...
	for(var i=2; i<document.getElementById("stats_table").rows.length; i++){
		var homeS = parseInt(document.getElementById("stats_table").rows[i].cells[2].innerHTML);
		var oppoS = parseInt(document.getElementById("stats_table").rows[i].cells[3].innerHTML);
		if(homeS >= oppoS){
...
document.getElementById("wins").innerHTML = homeW;
document.getElementById("losses").innerHTML = homeL;
}
/*
document.getElementById("stats_table").rows[2].cells[2].innerHTML;
parseInte(.....);
